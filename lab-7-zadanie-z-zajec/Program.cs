...
namespace lab_7_zadanie_z_zajec
{
    delegate String IntFormatter(int a);

    delegate double operation(double a, double b);

    //string Format("{}")  - do jednego z zadan
    // String zmienicn a string wszedzie, chyba?
    class Program
    {
        ...
        public static Predicate<string> IsPhoneNumber()
        {
            ...
            return s => s.Length == 9 && s.All(char.IsDigit);
        }
        ...
        public static List<Person> ProcessPeople(List<String> data)
        {
            ...
            //Predicate<string> strLambda = s => s.;
            //return LoadPeople(data, strLambda);
        }
